...
const features = [
  { icon: Truck, title: "Envíos a todo Uruguay", description: "Llegamos a cada rincón del país con tu pedido.", color: "text-secondary" },
  { icon: Palette, title: "Diseños únicos", description: "Anime, gaming, arte urbano y moda contemporánea.", color: "text-primary" },
  { icon: MessageCircle, title: "Atención personalizada", description: "Te asesoramos para crear el producto perfecto.", color: "text-secondary" },
];
